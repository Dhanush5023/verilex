    ...
    <div style={{ 
      ...
      <div className="card" style={{ maxWidth: 420, width: '100%', padding: '36px 32px', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 24 }}>
          <button className="btn btn-secondary btn-sm" onClick={() => handleSocialRegister('Google')} style={{ gap: 8 }}>
          ...
          <button className="btn btn-secondary btn-sm" onClick={() => handleSocialRegister('GitHub')} style={{ gap: 8 }}>
